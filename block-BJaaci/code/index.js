...
for (let genre of movies[0].genres) console.log(genre);
...
for (let genre of movies[1].genres) console.log(genre);
...
for (let movie of movies) console.log(movie.year == 2017);

// 23. Log the title of all three movies one by one.

for (let movie of movies) console.log(movie.title);

// 24. Log if the title of the first movie is `` or not
